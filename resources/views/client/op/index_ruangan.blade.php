@section('title', 'Peminjaman Ruangan - Operasional | Website KM-ITERA')

<x-client>
    <section class=" py-10 mx-auto opacity-80">
        <h1 class="w-1/2 mx-auto text-center text-neutral-white font-bold text-3xl ">Peminjaman Ruangan</h1>
    ...
    <section class="pt-10">
        <div class="flex justify-end gap-4 mx-8 md:mx-2">
            <input class="block rounded-md px-2 py-3 w-full md:w-1/4" placeholder="Cari Ruangan.." />
        ...
        <article class="grid grid-cols-1 md:grid-cols-4">
            @foreach ($ops as $op)
                <button
                    class="bg-custom-blue text-neutral-white font-bold mt-5 mx-8 rounded-lg text-left md:mx-3 md:mt-5 hover:-translate-y-3 hover:bg-black-75">
                    <div class="flex md:block">
                        ...
                        <div class="w-1/2 p-5 md:w-auto">
                            <h2 class="text-lg mb-10">{{ $op->nama_op }}</h2>
