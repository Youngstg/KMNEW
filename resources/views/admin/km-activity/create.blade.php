...
<script>
    ...
    title.onchange = function () {
        ...
        j.open("GET", "/admin/km-activity/create-slug?mode=create&title=" + title.value, true);
    ...
    slug.onchange = function () {
        ...
        s.open("GET", "/admin/km-activity/check-slug?mode=create&slug=" + slug.value, true);
    ...
    let today = new Date(nowDate.getFullYear(), nowDate.getMonth(), nowDate.getDate(), nowDate.getHours(), nowDate.getMinutes(), nowDate.getSeconds(), 0, 0, 0, 0, 0, 0, 0);
            ...
            <div class="col-12 form-wrapper">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Buat Aktivitas Baru</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST" action="{{ route('admin.km-activity.store') }}" enctype='multipart/form-data'>
                        @csrf
                        <div class="card-body" style="overflow-x:overlay;">
                            <div class="form-group">
                                <label for="title_kmac">Tema</label>
                                <input name="title_kmac" value="{{ old('title_kmac') }}" required
                            ...
                            <div class="form-group">
                                ...
                                <input name="ketuplak_kmac" value="{{ old('ketuplak_kmac') }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group has-validation position-relative">
                                    ...
                                    <input name="slug_kmac" value="{{ old('slug_kmac') }}" required
                                    ...
                                    <div id="slugHelpBlock" class="form-text">
                                        ...
                                        setelah setiap
                                        kata, sedangkan spasi dan karakter la



                                        innya akan diubah menjadi tanda strip. <br>
                                        Slug
                            ...
                            <div class="form-group mt-4">
                                ...
                                <select name="tag_kmac[]" class="form-control" id="tag_kmac" style="width: 100%;"
                                    required>
                            ...
                            <div class="form-group">
                                <label for="gambar_kmac">Gambar</label>
                                ...
                                <input type="file" name="gambar_kmac" id="gambar_kmac"
                                    class="form-control @error('gambar_kmac') is-invalid @enderror" accept="image/*"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="konten_kmac" required value="{{ old('konten_kmac') }}"
                                    class="form-control custom-txt-area" placeholder="Masukkan konten aktivitas..."
                                    id="konten_kmac">{{ old('konten_kmac') }}</textarea>
                                @error('konten_kmac')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi_kmac" required value="{{ old('deskripsi_kmac') }}"
                                    class="form-control custom-txt-area"
                                    placeholder="Masukkan deskripsi singkat aktivitas..."
                                    id="deskripsi_kmac">{{ old('deskripsi_kmac') }}</textarea>
                            ...
                            <div class="">
                                ...
                                <input name="features_kmac" checked="{{ old('features_kmac') }}"
