        ...
        <div class="row">
            ...
            <div class="col-12 form-wrapper">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form method="POST" action="{{ route('admin.kabinet.store') }}" enctype='multipart/form-data'>
                        @csrf
                        <div class="card-body" style="overflow-x:overlay;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="tahun_kbt"
                                    ...
                                    placeholder="Masukkan Tahun awal saja" required value="{{ old('tahun_kbt') }}">
                                @error('tahun_kbt')
                            ...
                            <div class="form-group">
                                ...
                                <input name="logo_kbt" class="form-control @error('logo_kbt') is-invalid @enderror"
                                    id="gambar" type="file" accept="image/*" onchange="previewNewImage(event, 'Logo')">
                                @error('logo_kbt')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="desk_kbt"
                                    ...
                                    placeholder="Masukkan Deskripsi Kabinet">{{ old('desk_kbt') }}</textarea>
                                @error('desk_kbt')
                            ...
                            <div class="">
                                ...
                                <input name="status_kbt" checked="{{ old('status_kbt') }}"
